namespace Mo3RegUI
{
    public static class Constants
    {
        ...
        public const string AppName = "Register for " + GameName;
        ...
        public const string AuthorName = "SadPencil"; // You are not supposed to remove the name here. Append your name if you have made significant changes.
